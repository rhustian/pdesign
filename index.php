        ...
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
                    ...
                    <li><a href="register.html">Registrarse</a>
                    </li>
                    <li><a href="#">Lo más visto</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.html" data-animate-hover="bounce">
                    <img src="http://pilardesign.s3.amazonaws.com/logo_transparencia.png" alt="Obaju logo" class="hidden-xs pd-logo">
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <h5>Acolchados</h5>
                                            <ul>
                                                <li><a href="category.html">Una plaza y media</a>
                                                </li>
                                                <li><a href="category.html">Dos plazas y media</a>
                                                </li>
                                                <li><a href="category.html">Queen</a>
                                                </li>
                                                <li><a href="category.html">King</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-3">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Envios <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Contacto <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                    ...
                    <div class="same-height-row">
                        ...
                        <div class="col-sm-6">
                            <div class="box same-height clickable box-features" style="height: 1px !important">
                                ...
                                <img src="http://pilardesign.s3.amazonaws.com/mercado-pago.png" alt="Pago Seguro" class="img-home-features">
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="../Pagina/carrusel-1.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="../Pagina/carrusel-2.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="../Pagina/carrusel-3.png" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
